...
export default function Sidebar({
  open, chats, chatsLoading, activeChatId, activeView,
  memories, user, dark,
  onNewChat, onLoadChat, onToggle, onSignOut, onViewChange, onDarkToggle,
}) {
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sb-nav">
        ...
        <button
          className={`sb-nav-btn ${activeView === 'documents' ? 'active' : ''}`}
        ...
        <button
          className={`sb-nav-btn ${activeView === 'analytics' ? 'active' : ''}`}
      ...
      <div className="sb-user">
        ...
        <button className="sb-signout" onClick={onDarkToggle} title={dark ? 'Light mode' : 'Dark mode'}>
          {dark ? (
